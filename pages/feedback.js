...
export default function FeedbackPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6 relative">
      ...
      <p className="text-center text-gray-600">Merci de prendre une minute pour nous dire ce que tu en as pensé de cette présentation.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="font-medium">💔 Qu’est-ce que tu n'aimes pas?</label>
