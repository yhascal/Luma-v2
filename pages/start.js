...
export default function SelectionFlow() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-6 space-y-8 bg-gray-50 text-gray-900">
      {!question ? (
        <>
          <h1 className="text-3xl font-bold text-center mb-4">Choisis une question :</h1>

          <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-900 p-4 rounded-lg max-w-2xl text-sm leading-relaxed">
            ⚠ Le but ici est de comparer les scénarios d’<strong>UNE MÊME PROBLEMATIQUE</strong>, pour voir comment Luma adapte sa façon de s’exprimer et la pédagogie utilisée en fonction du profil de l’utilisateur.<br /><br />
            Il y a 2 questions disponibles :<br />
            – une plutôt abstraite (question 1)<br />
            – une demande concrète (question 2)
          </div>

          <div className="space-y-6 w-full max-w-xl mt-6">
            <button
